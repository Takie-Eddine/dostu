                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{route('client.manage.role-permissions.update',$role->id)}}" method="POST">
                                    @csrf
                                    <div class="row">
                                            ...
                                            @foreach (config('global.permissions_client') as $name => $value)
                                                <div class="form-group col-sm-4">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" class="chk-box" name="permissions_client[]" value="{{ $name }}" {{ in_array($name, $role->permissions_client)? 'checked' : '' }}>  {{ $value }}
                                                    </label>
                                                </div>
                                            @endforeach
