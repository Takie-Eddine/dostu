                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2 my-25">
                            ...
                            <div class="d-flex">
                                ...
                                <form class="form" action="{{route('client.setting.profile.update',$client->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$client->id}}">
                                    {{-- <input type="hidden" name="role_id" value="{{$client->role_id}}"> --}}
                            ...
                            <!-- form -->
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="accountFirstName" name="first_name" placeholder="John" value="{{$client->first_name}}" data-msg="Please enter first name" />
                                        @error('first_name')
                                        <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="accountLastName" name="last_name" placeholder="Doe" value="{{$client->last_name}}" data-msg="Please enter last name" />
                                        @error('last_name')
                                        <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <input type="text" class="form-control account-number-mask" id="accountPhoneNumber" name="mobile" placeholder="Phone Number" value="{{$client->mobile}}" />
                                        @error('mobile')
                                        <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
