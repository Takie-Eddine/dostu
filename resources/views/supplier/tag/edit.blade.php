                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{route('supplier.tag.update',$tag->id)}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="first-name-column">Name</label>
                                                <input type="text" id="first-name-column" class="form-control" placeholder="Name" name="name" value="{{$tag->name}}" />
                                                @error('name')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="last-name-column" class="form-control" placeholder="Slug-Name" name="slug" value="{{$tag->slug}}" />
                                                @error('slug')
                                                <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                            </div>
