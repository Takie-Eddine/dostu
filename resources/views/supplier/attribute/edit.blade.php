                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('supplier.tag.index')}}">Attributes</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{route('supplier.attribute.update',$attribute->id)}}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="first-name-column" class="form-control" placeholder="Name" name="name" value="{{$attribute->name}}" />
                                            </div>
                                            @error('name')
