                                    ...
                                    <div id="account-details-modern" class="content" role="tabpanel" aria-labelledby="account-details-modern-trigger">
                                        ...
                                        <div class="row">
                                            <div class="mb-1 form-password-toggle col-md-6">
                                                ...
                                                <textarea type="text" id="description" name="description" value="{{$item->description}}" class="form-control" placeholder="description" rows="1"></textarea>
                                                @error('description')
                                                <span class="text-danger"> {{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 form-password-toggle col-md-6">
                                                ...
                                                <input type="file" id="logo" name="logo" value="{{$item->logo}}" class="form-control" placeholder="upload image" />
                                                @error('logo')
                                                <span class="text-danger"> {{$message}}</span>
                                                @enderror
                                            </div>
                            ...
                            <div class="bs-stepper-content">
                                ...
                                <div id="social-links-modern" class="content" role="tabpanel" aria-labelledby="social-links-modern-trigger">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="facebook">Facebook</label>
                                            <input type="text" id="facebook" name="facebook" value="" class="form-control" placeholder="https://facebook.com/abc" />
                                            @error('facebook')
                                            <span class="text-danger"> {{$message}}</span>
                                            @enderror
                                        </div>
